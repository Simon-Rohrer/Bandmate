...
const Bands = {
    ...
    async openBandRiderEditor(bandId) {
        this.currentBandId = bandId;
        if (typeof App !== 'undefined' && typeof App.showBandRiderExportModal === 'function') {
            await App.showBandRiderExportModal(bandId);
            return;
        }

        UI.showToast('Der Rider-Editor konnte nicht geöffnet werden.', 'error');
    }
};
